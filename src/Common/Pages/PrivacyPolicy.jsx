      ...
      <div className="w-full max-w-5xl">
        ...
        <div className="space-y-8">
          <p className="font-medium md:text-[1.4rem] sm:text-lg md:leading-relaxed">
            At MOX, your privacy is our priority. This Privacy Policy explains
          ...
          <div>
            ...
            <p className="font-medium md:text-[1.4rem] sm:text-lg md:leading-relaxed">
              • Personal information you provide (e.g., name, email, wallet
              address). <br />
          ...
          <div>
            ...
            <p className="font-medium md:text-[1.4rem] sm:text-lg md:leading-relaxed">
              • To provide and improve MOX services. <br />
              • To process transactions securely. <br />
              • To communicate important updates, promotions, or service changes.
            </p>
          </div>

          <div>
            <h3 className="text-2xl font-bold mb-3">3. Data Protection</h3>
            <p className="font-medium md:text-[1.4rem] sm:text-lg md:leading-relaxed">
              • We apply strict security measures to safeguard your information.
              <br />
              • We do not share, sell, or rent your personal data to third
              parties without consent, except as required by law.
            </p>
          </div>

          <div>
            <h3 className="text-2xl font-bold mb-3">4. Cookies</h3>
            <p className="font-medium md:text-[1.4rem] sm:text-lg md:leading-relaxed">
              • MOX may use cookies to enhance your browsing experience. <br />
              • You can disable cookies in your browser settings.
            </p>
          </div>

          <div>
            <h3 className="text-2xl font-bold mb-3">5. Third-Party Links</h3>
            <p className="font-medium md:text-[1.4rem] sm:text-lg md:leading-relaxed">
              Our website may include links to third-party platforms. MOX is
              not responsible for their content or privacy practices.
            </p>
          </div>

          <div>
            <h3 className="text-2xl font-bold mb-3">6. Your Rights</h3>
            <p className="font-medium md:text-[1.4rem] sm:text-lg md:leading-relaxed">
              • You may request access, correction, or deletion of your personal
              data. <br />
              • For inquiries, contact us at{" "}
              <a
                href="mailto:support@mox.co"
