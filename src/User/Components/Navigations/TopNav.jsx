...
import logo from "../../../assets/userImages/Logo/MOX COIN 1.png"
...
const TopNav = () => {
  ...
  return (
    <header className=" z-[99] lg:sticky fixed top-0 right-0   bg-[#1a1a1a]  flex w-[100%]  border-gray-200  dark:border-gray-800   backdrop-blur-xl lg:border-b">
